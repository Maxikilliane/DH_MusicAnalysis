...
class IndividualChoice(Choice):
    def get(self, request):
        ...
        self.context_dict["explanation"] = "You can analyze a single piece of music in different ways. First you need to either upload a file (in one of the valid formats) or choose a music piece from the corpus. By clicking the 'Analyze' Button the file gets rendered and you can choose which types of analysis you want to perform: Displaying all chords, displaying all intervals, show ambitus or show key."
